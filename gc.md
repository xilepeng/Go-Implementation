...
1. [1. 什么是 GC，有什么作用？](#1-什么是-gc有什么作用)
2. [2. 根对象到底是什么？](#2-根对象到底是什么)
3. [3. 常见的 GC 实现方式有哪些？Go 语言的 GC 使用的是什么？](#3-常见的-gc-实现方式有哪些go-语言的-gc-使用的是什么)
4. [4. 三色标记法是什么？](#4-三色标记法是什么)
5. [5. STW 是什么意思？](#5-stw-是什么意思)
6. [6. 如何观察 Go GC？](#6-如何观察-go-gc)
7. [7. 有了 GC，为什么还会发生内存泄露？](#7-有了-gc为什么还会发生内存泄露)
